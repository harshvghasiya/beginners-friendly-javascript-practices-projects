...
<article class="hentry post post-standard has-post-thumbnail sticky">
  ...
  <div class="post__content">
    <div class="post__author author vcard">
      <img src="<?php echo e($blog->createdBy->getAdminUserImageUrl()); ?>" class="auther_image" alt="author">
      Posted by
      <div class="post__author-name fn">

        <a href="<?php echo e(route('front.author.detail',$blog->createdBy->slug)); ?>" class="post__author-link"><?php echo e($blog->createdBy->name); ?></a>
      </div>
    </div>
